...
class Config:
    ...
    mode = 'joint'
    model_name = 'bert-base-uncased' # 'bert-base-uncased'/'deberta-large'/'roberta-large'/
    # 'roberta-base'/'deberta-large'/'deberta-base'/'ModernBERT-base'/'ModernBERT-large'
    # 'gemma'
    ...
    batch_size = 8
    lambda_XtoC = 0.5 # 0.5     # parameter for the loss of the joint strategy
    is_aux_logits = False
    num_epochs = 10
    ...
    DATASET = "dbpedia" #"medical"/"dbpedia"/"agnews"/ "movies" 
