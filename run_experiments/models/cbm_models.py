...
# def ModelXtoC_function(num_classes, n_attributes, bottleneck, expand_dim,connect_CY=False,Lstm=False,aux_logits=False, dim=768):
#     ModelXtoC_layer = ModelXtoC(num_classes = num_classes, n_attributes=n_attributes, bottleneck=bottleneck, expand_dim=expand_dim,connect_CY=connect_CY,Lstm=Lstm,aux_logits=aux_logits, dim=dim)
