...
def prepare_agnews_data(config):
    ...
    if infra == "DATABRICKS":
        # Chemins des données
        save_path_dictionary = "/dbfs/mnt/ekixai/main/data/Interpretability/concept_xai/experiment/results_agnews/concepts_discovery" # this line change when we go to A100
    else:
        save_path_dictionary = "/home/bhan/Yann_CBM/Launch/dbfs/results_agnews/concepts_discovery" # this line change when we go to A100    
